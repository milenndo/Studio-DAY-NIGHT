...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    bio: 'Здравейте, казвам се Калина! В beauty сферата съм от 2018г. Преминала съм редица обучения за миглопластика и оформяне на вежди. Моята цел е да подчертая естествената ви красота, без да я променям драстично. Държа на уюта и личното отношение към всеки клиент.',
    rating: 5.0,
    reviewCount: 120,
    image: '/assets/images/kalina.png'
  },
  {
    id: 'maria',
    name: 'Мария',
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 84,
    image: '/assets/images/vladislava.png'
  },
  {
    id: 'aleksandra',
    name: 'Александра',
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 95,
    image: '/assets/images/maria-mladenova.png'
  }
];
